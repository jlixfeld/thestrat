"""DEFUNCT — placeholder for the pre-1.0 thestrat.indicators module.
...
raise ImportError(
    "thestrat has been rewritten in 1.0.0. The module 'thestrat.indicators' "
    "no longer exists.\n"
    ...
    "    from thestrat import classify_bars_df, classify_bar"
)
